function init() {
    ...
    d3.json("https://github.com/pratishthasingh1/bacteria_analysis/blob/main/samples.json").then((metaData) => {
    console.log(data)
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var selectedSample = samplesArray.filter(f => f.id == sample);
    ...
    // so the otu_ids with the most bacteria are last.
      ...
      var xticks = top_ten_samples.sort((a,b) => b-a);

      var yticks = top_ten.map(d => "otu${d}");
