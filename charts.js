function init() {
    ...
    // Use the list of sample names to populate the select options
      d3.json("https://raw.githubusercontent.com/pratishthasingh1/bacteria_analysis/main/samples.json").then((data) => {var sampleNames = data.names;
...
function buildMetadata(sample) {
  ...
  function buildCharts(sample) {
    ...
    d3.json("https://raw.githubusercontent.com/pratishthasingh1/bacteria_analysis/main/samples.json").then((metadata) => {
      ...
      var samplesArray = metadata.samples;
